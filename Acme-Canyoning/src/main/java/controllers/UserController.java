...
public class UserController extends AbstractController {
	...
	public ModelAndView create() {
		...
		userRegisterForm = new CustomerRegisterForm();
	...
	public ModelAndView register(@Valid CustomerRegisterForm userRegisterForm,
	...
	public ModelAndView save(@Valid CustomerRegisterForm userRegisterForm,
			BindingResult binding) {
		ModelAndView result;
		Boolean verificarContrasenas;
