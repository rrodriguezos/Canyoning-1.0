...
public class TripUserController extends AbstractController {
	...
	public ModelAndView list() {
		...
		for (Banner c : bannersActivos) {
			for (String palabra : c.getKeyWords()) {
				Collection<Canyon> tripis = tripService
	...
	public ModelAndView save(@Valid Canyon trip, BindingResult binding,
	...
	public ModelAndView delete(@Valid Canyon trip, BindingResult binding) {
		ModelAndView result;
	...
	public ModelAndView copy(@RequestParam int tripId) {
		...
		Canyon trip = tripService.findOne(tripId);
	...
	protected ModelAndView createEditModelAndView(Canyon trip) {
		ModelAndView result;
	...
	protected ModelAndView createEditModelAndView(Canyon trip, String message) {
		ModelAndView result;
